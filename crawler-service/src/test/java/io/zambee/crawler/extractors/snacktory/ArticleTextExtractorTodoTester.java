...
public class ArticleTextExtractorTodoTester {
    ...
    public void testEspn2() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("espn2.html")));
    ...
    public void testWashingtonpost() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("washingtonpost.html")));
    ...
    public void testBoingboing() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("boingboing.html")));
    ...
    public void testReadwriteWeb() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("readwriteweb.html")));
    ...
    public void testYahooNewsEvenThoughTheyFuckedUpDeliciousWeWillTestThemAnyway() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("yahoo.html")));
    ...
    public void testLifehacker() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("lifehacker.html")));
    ...
    public void testNaturalhomemagazine() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("naturalhomemagazine.html")));
    ...
    public void testSfgate() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("sfgate.html")));
    ...
    public void testScientificdaily() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("scientificamerican.html")));
    ...
    public void testUniverseToday() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("universetoday.html")));
    ...
    public void testCNBC() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("cnbc.html")));
    ...
    public void testMsnbc() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("msnbc.html")));
    ...
    public void testTheAtlantic() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("theatlantic.html")));
    ...
    public void testGawker() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("gawker.html")));
    ...
    public void testNyt2() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("nyt2.html")));
    ...
    public void testGettingVideosFromGraphVinyl() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("grapevinyl.html")));
    ...
    public void testLiveStrong() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("livestrong.html")));
    ...
    public void testLiveStrong2() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("livestrong2.html")));
    ...
    public void testCracked() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("cracked.html")));
    ...
    public void testMidgetmanofsteel() throws Exception {
        //String url = "http://www.cracked.com/article_19029_6-things-social-networking-sites-need-to-stop-doing.html";
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("midgetmanofsteel.html")));
    ...
    public void testTrailsCom() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("trails.html")));
    ...
    public void testTrailsCom2() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("trails2.html")));
    ...
    public void testEhow() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("ehow.html")));
    ...
    public void testGolfLink() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("golflink.html")));
    ...
    public void testNewsweek() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("newsweek.html")));
...
//                article.getImageUrl());
    ...
    public void testBusinessweek() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("businessweek.html")));
    ...
    public void testNature() throws Exception {
        ...
        JResult article = extractor.extractContent(c.streamToString(getClass().getClassLoader().getResourceAsStream("nature.html")));
